        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomeRepresentante = table.Column<string>(maxLength: 60, nullable: true),
                    EndComplemento = table.Column<string>(maxLength: 20, nullable: true),
                    EndNumero = table.Column<string>(maxLength: 8, nullable: true),
                    Site = table.Column<string>(maxLength: 60, nullable: true),
                    TipoEmpresa = table.Column<int>(nullable: false),
                    NumDocumento = table.Column<string>(maxLength: 60, nullable: false),
                    InscrEstadual = table.Column<string>(maxLength: 30, nullable: true),
                    InscrMunicipal = table.Column<string>(maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescricaoLonga = table.Column<string>(maxLength: 50, nullable: false),
                    DescricaoCurta = table.Column<string>(maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FotoUsuario = table.Column<string>(nullable: true),
                    Ativo = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Estoque", x => new { x.LojaId, x.ProdutoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DataHora = table.Column<DateTime>(nullable: false),
                    Justificativa = table.Column<string>(maxLength: 150, nullable: false),
                    DataHoraInformada = table.Column<DateTime>(nullable: false),
                    ValorTotal = table.Column<double>(nullable: false),
                    UsuarioId = table.Column<int>(nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntradaEstoqueId = table.Column<int>(nullable: false),
                    ProdutoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Qtd = table.Column<double>(nullable: false),
                    ProdutoId = table.Column<int>(nullable: false),
                    SaidaEstoqueId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
